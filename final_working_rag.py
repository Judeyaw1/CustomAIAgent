#!/usr/bin/env python3
"""
Final Working RAG System - Properly Uses Virtual Environment
"""
import os
import sys
import subprocess
...
def chat():
    ...
    try:
        ...
        # Use the virtual environment Python with proper path
        venv_python = os.path.join(os.getcwd(), '.venv', 'bin', 'python3')
        
        # Set environment variables to ensure we use the virtual environment
        env = os.environ.copy()
        env['PYTHONPATH'] = os.path.join(os.getcwd(), '.venv', 'lib', 'python3.12', 'site-packages')
