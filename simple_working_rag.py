#!/usr/bin/env python3
"""
Simple Working RAG System - No Socket.IO Issues
"""
import os
import sys
import subprocess
...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'timestamp': time.time(),
        'mode': 'simple_working_rag'
    })

def main():
    """Main startup function"""
    print("🚀 Starting Simple Working RAG System...")
    print("=" * 50)
    ...
    print("=" * 50)
    print("🎉 Simple Working RAG System Ready!")
    print("🌐 Open your browser to: http://localhost:8092")
